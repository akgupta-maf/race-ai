  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Your intelligent retail analytics assistant powered by AI" />
      </Helmet>
          ...
          <div className="row align-items-center mb-5">
            ...
            >
              ...
              <p className="text-secondary fs-5">
                RACE GPT is an advanced AI assistant specifically designed for retail analytics. 
                It understands your business context and helps you extract insights from your 
                data using simple, natural language queries.
              </p>
              <p className="text-secondary">
                Whether you need quick insights, detailed analysis, or help understanding complex 
                data patterns, RACE GPT is here to help 24/7.
              </p>
            </motion.div>
          </div>
        </div>
