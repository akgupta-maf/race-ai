...
const Promotion: React.FC = () => {
  ...
  const SectionHeader: React.FC<{ title: string; description: string }> = ({
    ...
    <div className='mb-14 text-center'>
      <h2 className='mb-3 text-3xl font-bold text-[var(--color-primary)] md:text-4xl'>
        {title}
      </h2>
      <p className='mx-auto max-w-3xl text-base leading-7 text-[var(--color-typography-secondary)]'>
        {description}
      </p>
    </div>
  );
              ...
              {features.map((feature, index) => (
                ...
                >
                  <article className='flex h-full flex-col gap-3 rounded-xl border border-[var(--color-primary-20)] bg-white p-7 shadow-[0_6px_16px_rgba(15,23,42,0.06)] transition hover:-translate-y-1 hover:shadow-[0_14px_26px_rgba(15,23,42,0.12)]'>
                    ...
                    <p className='m-0 leading-7 text-[var(--color-typography-secondary)]'>
                      {feature.description}
                    </p>
                  </article>
                </motion.div>
              ...
              {benefits.map((benefit, index) => (
                ...
                >
                  <div className='flex items-start gap-3 px-1 py-4'>
                    ...
                    <div>
                      <h4 className='mb-1 text-lg font-bold text-[var(--color-primary)]'>
                        {benefit.title}
                      </h4>
                      <p className='m-0 leading-7 text-[var(--color-typography-secondary)]'>
                        {benefit.description}
